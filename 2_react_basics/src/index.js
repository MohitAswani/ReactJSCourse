...
// This tells react where this user interface which we build with react in the end should be placed in the web page.
...
// The below is not a regular js syntax rather its a special js syntax called jsx.
root.render(<App />);
